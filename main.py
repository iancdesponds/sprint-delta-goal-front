...
def cruzamentos():
    data = requests.get("https://sprint-delta-goal-backend-d98d692a89ea.herokuapp.com/cruzamentos/geral")
...
@app.route("/quebras")
def quebras():
    destaques = requests.get("https://sprint-delta-goal-backend-d98d692a89ea.herokuapp.com/quebra_linha/destaques")
